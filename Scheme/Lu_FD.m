...
% FD preconditioner of Chebyshev or Fourier pseudospectral methods
%
% L is the FD operator for the given PDE in the form
%
% au_xx+bu_yy+c*u=f
% OR
% au_xx+bu_x+c*u=f 
