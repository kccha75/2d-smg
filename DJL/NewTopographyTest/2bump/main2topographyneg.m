...
gamma_star=-0.5;% keep small! to get the initial solution
mu=0.7; % topography width scale
KAI=25; % fKdV domain, since L=50
...
DJL.N2=N2;
DJL.N2d=N2d;
DJL.topography=@(X) sech(X+8).^2+sech(X-8).^2; % in KAI domain ...
...
% Initial guess
[DJL,fKdV,pdefkdv,domainfkdv,optionfkdv]=DJLv0_2topography_neg(DJL,domain,option);
v0=DJL.v;
