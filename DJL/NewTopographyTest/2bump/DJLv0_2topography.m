...
function [DJL,fKdV,pdefkdv,domainfkdv,optionfkdv]=DJLv0_2topography(DJL,domain,option)
...
if DJL.soltype==3 % 2 bump fKdV continuation solitary wave +ve branch
    ...
    delta_star=(gamma_star-gamma_cont(Bindex))*(lambda_cont(Bindex+1)-lambda_cont(Bindex)) ...
        /(gamma_cont(Bindex+1)-gamma_cont(Bindex))+lambda_cont(Bindex);
