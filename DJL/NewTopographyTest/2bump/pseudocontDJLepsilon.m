...
%
% Updates parameter epsilon in continuation (where epsilon is the parameter
% in N2(z)=epsilon*z+(1-epsilon)sech^2((z-z0)/d)
%
% Input:
...
function [V,U]=pseudocontDJLepsilon(v,dv,lambda,dlambda,DJL,domain,option,cont_option)
...
% -------------------------------------------------------------------------
    for i=1:Newtonmaxit
        ...
        RHS1=J.f;
        RHS2=d/depsilon(equation); RHS2(:,end)=0;
