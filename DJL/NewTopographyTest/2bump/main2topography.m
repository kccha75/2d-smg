...
% Calculate momentum
P=trapI(V.^2,DJL.Lx/domain.N(1)); % Integrate x
P=permute(P,[2,1,3]);
...
P2=trapI(zeta0_map.^2,DJL.Lx/domain.N(1)); % Integrate x
P2=permute(P2,[2,1,3]);
P2=clenshaw_curtis(P2)/2*DJL.Ly/domain.H; % Integrate y
P2=permute(P2,[3,1,2]);

% Calculate momentum 1st order
P3=trapI(zeta_map.^2,DJL.Lx/domain.N(1)); % Integrate x
P3=permute(P3,[2,1,3]);
