...
%
% Updates parameter topography height in continuation
% Note this requires conformal mapping at every step
%
% Input:
...
function [V,U]=pseudocontDJL2(v,dv,lambda,dlambda,DJL,domain,option,cont_option)
