...
% coarse grid can go down to 3 ... but some issues with 3, stick with 4
% -------------------------------------------------------------------------
...
legend('CG','SMG coarse grid N=4','SMG coarse grid N=5','SMG coarse grid N=6','SMG coarse grid N=7','Location','NorthWest')